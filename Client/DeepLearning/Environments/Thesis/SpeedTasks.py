...
class FirstSettlement(CatanBaseEnv):
    def __init__(self, customBoard=None, players=None, trading=False):
        super(FirstSettlement, self).__init__(customBoard=customBoard, players=players, trading=trading)
    ...
    def reset(self, seed=None):
        self.numTurns = 0
        return super(FirstSettlement, self).reset()
...
class FirstCity(CatanBaseEnv):
    def __init__(self, customBoard=None, players=None, trading=False):
        super(FirstCity, self).__init__(customBoard=customBoard, players=players, trading=trading)
    ...
    def reset(self, seed=None):
        self.numTurns = 0
        return super(FirstCity, self).reset()

    def endCondition(self) -> bool:
        if self.game.gameState.currState == "OVER" or len(self.agent.cities) >= 1:
            return True
        else:
            return False
